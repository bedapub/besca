...
.libPaths(libloc)
if (!require("devtools")) install.packages("pacman", lib = libloc)
if (!require("withr")) install.packages("pacman", lib = libloc)
...
if (!require("Matrix")) install.packages("data.table", lib = libloc)
